...
class Algorithm:
    ...
    def __init__(self, env: gym.Env, other_policy: OtherPolicy,
    ...
    def render_episode(self) -> float:
        ...
        for _i in range(self.max_steps):
            ...
            other_state = tf.constant(info[Algorithm.OTHER_STATE],
                                      dtype=tf.float32)
            total_reward += reward
    ...
    def _tf_env_step(self, action: tf.Tensor,
        ...
        return tf.numpy_function(self._env_step, [action, other_action],
